...
from vectorstore.qdrant_responses import SearchResultList


SearchExecutor = Callable[[str, Dict[str, Any], float], SearchResultList]


def normalize_query_inputs(terms: Sequence[str] | None, fields: Sequence[str] | None) -> tuple[List[str], List[str]]:
