    ...
    def from_env(cls) -> "TemporalRagSettings":
        return cls(
            ...
            scraper_url=_env(
                ...
                _env("CUSTOM_CRAWLER_URL", "http://crawl4ai-service"),
            ),
            scraper_start_path=_env("EXTERNAL_SCRAPER_START_PATH", "/crawl"),
            scraper_status_path=_env("EXTERNAL_SCRAPER_STATUS_PATH", "/status/{job_id}"),
