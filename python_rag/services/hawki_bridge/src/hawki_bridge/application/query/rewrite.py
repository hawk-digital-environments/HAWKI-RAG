...
from hawki_bridge.application.query.settings import int_env
from hawki_rag_text.preprocessing import (
    _is_multimodal_query as _default_is_multimodal_query,
)
from hawki_rag_text.preprocessing import _normalize_list as _default_normalize_list
from hawki_rag_text.preprocessing import _rewrite_query as _default_rewrite_query
from hawki_rag_text.preprocessing import _extract_terms as _default_extract_terms
...
def build_query_rewrite(
    ...
    *,
    ...
    rewrite: dict[str, Any] = (
        {} if not rewrite_enabled else rewrite_query(provider, query)
    )
    return {
