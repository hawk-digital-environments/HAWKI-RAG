...
redaction behavior centralized so multiple adapters and API boundaries share
consistent behavior.
"""
...
# ---- Event names used for observability/logging ----
...
def sanitize_for_log(message: object, *, max_length: int = 2048) -> str:
    ...
    for pattern in _SECRET_PATTERNS:
        safe = pattern.sub("\\1=<redacted>", safe)
...
def preview_request_body(body: bytes | bytearray | str | None, *, content_type: str | None, max_length: int = DEFAULT_REQUEST_BODY_SNIPPET_BYTES) -> str | None:
