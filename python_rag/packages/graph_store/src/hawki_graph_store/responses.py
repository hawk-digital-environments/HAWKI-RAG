...
from hawki_graph_store.contracts import GraphFact, GraphStructuralHit
from hawki_graph_store.normalization import dedupe_one_way_triplets


Neo4jFactRow = GraphFact
Neo4jStructuralRow = GraphStructuralHit
