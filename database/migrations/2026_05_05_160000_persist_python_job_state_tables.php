...
return new class extends Migration
{
    ...
    {
        Schema::dropIfExists('worker_job_tracking');
        Schema::dropIfExists('rabbitmq_queue_state');

        if (Schema::hasTable('job_processing_state')) {
            DB::statement('ALTER TABLE job_processing_state MODIFY job_id CHAR(36) NOT NULL');
        }
    }
};
