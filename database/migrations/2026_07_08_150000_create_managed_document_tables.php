...
return new class extends Migration
{
    ...
    {
        // This renamed migration may have been recorded after discovering
        // tables created by the previous storage migration. A rollback cannot
        // safely determine ownership, so it must not drop managed data.
    }
};
