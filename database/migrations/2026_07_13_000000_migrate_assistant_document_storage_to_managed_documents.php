...
return new class extends Migration
{
    ...
    {
        // This is a forward-only storage migration. Recreating the legacy
        // assistant tables during rollback could discard newer managed data.
    }
    ...
    private function assertAllLegacyRowsCopied(): void
    {
        ...
        if ($hasMissingDocuments) {
            throw new RuntimeException('Managed document migration verification failed; legacy assistant tables were retained.');
        }
        ...
        if ($hasMissingOutputs) {
            throw new RuntimeException('Managed document output migration verification failed; legacy assistant tables were retained.');
        }
    }
