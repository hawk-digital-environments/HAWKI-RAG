...
#[Singleton]
readonly class HeapIdentifierFactory
{
    public function heapId(mixed $value): string
    {
    ...
    public function displayName(string $heapId, mixed $value): string
    {
        return $this->stringValue($value) ?? Str::headline(str_replace(['_', '-'], ' ', $heapId));
    }
