...
{
    /**
     * Process a text file and create embedding
     */
    protected function processTextFile($file, $sourceFormat, $pageURL, $metaImgUrl, $title, $date)
    {
    ...
    /**
     * Process an image file and create embedding
     */
    protected function processImageFile($file, $sourceFormat, $pageURL, $metaImgUrl, $data, $title, $date)
    {
