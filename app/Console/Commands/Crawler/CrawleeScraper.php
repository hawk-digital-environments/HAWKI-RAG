...
//     * {--discovery-mode : Bool to discover urls inside the given page';
//     *
//     * 2- if the url is a sitemap, it should automatically detect and scrape all of the urls inside it (accordingly check the trottle parameters and max-pages limitation)
//     * If the url is a page url it should Automatically start detecting other urls inside the given url and crawl the website accordingly.
//     *
//     * 3- extract proper markdown text and images from the scraped url and return them in the following structure:
//     * - /images (folder)/ (including image files)
//     * - data_00001.json:
//     *  {
//     *    "title": [
//     *      "#firsttimes"
//     *    ],
//     *    "page_url": [
//     *      "https://projekte.g.hawk.de/projekt/5df0c5b6e1d79"
//     *    ],
//     *    "meta_img_url": [
//     *      "https://projekte.g.hawk.de/medien/medien/5df0c5b6e1d79/gallery/5e24b2cc57c29.jpg"
//     *    ],
//     *    "images": [
//     *      "https://projekte.g.hawk.de/medien/5df0c5b6e1d79/gallery/5e24b2cc57c29.jpg",
//     *      "https://projekte.g.hawk.de/medien/5df0c5b6e1d79/gallery/5e24b2cc59143.jpg",
//     *      "https://projekte.g.hawk.de/medien/5df0c5b6e1d79/gallery/5e24b2cc59fb8.jpg",
//     *      "https://projekte.g.hawk.de/medien/5df0c5b6e1d79/gallery/5e24b2cc5a4ab.jpg"
//     *    ],
//     *    "date": []
//     *  }
//     * - site_00001.md (containing the extracted text)
//     *
//     * You are free to add or remove extra config or features as you wish. However the input and output should be almost the same as the example given, so other microsevices and servers can expect the required data from this service.
...
//            $strategy = ScraperPipelineService::STRATEGY_CONTINUE;
//
...
//     *
//     * @param \App\Services\ScrapeService\Data\DirectoryAnalysis $analysis
//     * @return void
//     */
