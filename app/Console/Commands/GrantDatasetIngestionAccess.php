...
final class GrantDatasetIngestionAccess extends Command
{
    protected $signature = 'dataset:grant-ingest {dataset_id : Logical dataset identifier} {user_id : Local user ID}';

    protected $description = 'Grant a local user permission to ingest into one dataset';

    public function __construct(
        private readonly DatasetRepository $datasets,
        private readonly UserRepository $users,
        private readonly DatasetIngestionAuthorizationService $authorization,
    ) {
        parent::__construct();
    }
    ...
    public function handle(): int
    {
        ...
        $this->info(sprintf(
            'Granted user %s ingestion access to dataset %s.',
